...
class The7_Inc_Shortcodes_VCParams {
	...
	public function register_params() {
		...
		$this->compatible_vc_add_shortcode_param( 'dt_subtitle', array( $this, 'subtitle_settings_field' ) );
		...
		$this->compatible_vc_add_shortcode_param( 'dt_number_with_icon', array( $this, 'number_param_with_icon' ), $script_url );
	...
	public function dt_icon_settings_field($settings, $value)
		{
			...
			if($param_name == "gallery_image_zoom_icon"){
				$icons = array( 'icon-im-hover-000', 'icon-im-hover-001', 'icon-im-hover-005','icon-im-hover-003', 'icon-im-hover-004', 'icon-im-hover-009','icon-im-hover-010','icon-im-hover-011','icon-im-hover-012','icon-im-hover-013','icon-im-hover-021','icon-im-hover-022','icon-im-hover-023','icon-im-hover-024','icon-im-hover-031','icon-im-hover-032','icon-im-hover-041','icon-im-hover-042');
			}
...
foreach ( array( 'dt_gallery_photos_masonry' ) as $shortcode_tag ) {
	// Posts.
	add_filter( "vc_autocomplete_{$shortcode_tag}_posts_callback", array( $posts_autocomplete, 'suggester' ) );
	add_filter( "vc_autocomplete_{$shortcode_tag}_posts_render", array( $posts_autocomplete, 'renderer' ) );
